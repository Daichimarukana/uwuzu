...
if( !empty($_POST['btn_submit']) ) {
    ...
    $result = $dbh->prepare("SELECT userid, mailadds, loginid, authcode, encryption_ivkey, datetime FROM account WHERE userid = :userid");
        ...
        <p>IDと登録したメールアドレスを入力してください。</p>
            ...
            <form class="formarea" method="post">
                ...
                <div>
                    ...
                    <input id="mailadds" class="inbox" type="text" name="mailadds" value="<?php if( !empty($_SESSION['mailadds']) ){ echo safetext( $_SESSION['mailadds']); } ?>">
                </div>
